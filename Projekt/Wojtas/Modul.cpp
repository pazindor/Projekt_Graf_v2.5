...
void modul::Modul::znajdz_elementy_modulu(std::fstream &otwarty_plik) {
...
void modul::Modul::znajdz_funkcje_w_module(std::string slowo) {
...
void modul::Modul::dodaj_niepowtarzajacy_sie_modul(std::string nazwa_slowa) {
	int licznik = 0;

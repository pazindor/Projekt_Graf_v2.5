...
void graf::Graf::wykonaj() {
	...
	{
		cout << wszystkie_funkcje_we_wszystkich_plikach[i].nazwa_funkcji << endl;
	}
	
	cout << "=================================" << endl;
	for (int i = 0; i < pliki.size(); i++)
	{
		for (int j = 0; j < pliki[i].funkcje.size(); j++)
		{
			cout << pliki[i].nazwa_pliku << " -> " << pliki[i].funkcje[j].nazwa_funkcji << endl;
		}
	}
	...
	for (int i = 0; i < pliki.size(); i++)
	{
		...
		{
			cout << pliki[i].nazwa_pliku << " => " << pliki[i].namespacey[j].nazwa_przestrzeni << endl;
		}
	}
	...
	{
		for (int j = 0; j < przestrzenie_nazw[i].funkcje_modulu.size(); j++)
		{
			cout << pliki[i].nazwa_pliku << " => " << przestrzenie_nazw[i].funkcje_modulu[j].nazwa_funkcji << endl;
		}
	}
